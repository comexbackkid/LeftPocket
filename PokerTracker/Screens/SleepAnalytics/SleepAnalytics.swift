    ...
    var instructions: some View {
        ...
        VStack (alignment: .leading, spacing: 20) {
            ...
            .popover(isPresented: $howThisWorksPopup, arrowEdge: .bottom, content: {
                PopoverView(bodyText: "Once permissions are granted, we gather sleep numbers recorded from your smart device. If no sleep data is available, Left Pocket will default to using estimated \"In Bed\" times generated by Apple's Health App.")
