...
struct DeleteLocationTip: Tip {
    ...
    var message: Text? {
        Text("To add a location, press \(Image(systemName: "plus.circle.fill")) above. Tap & hold a thumbnail to modify it. If you imported data, be sure names match exactly.")
    }
