...
extension SessionsListViewModel {
    ...
    func countSessions(range: RangeSelection = .all, bankroll: SessionFilter) -> Int {
        ...
        case .all:
            ...
            case .threeMonth:
                return filterSessionsLastThreeMonths().count
            case .sixMonth:
        ...
        case .cash:
            ...
            case .threeMonth:
                return filterSessionsLastThreeMonths().filter { $0.isTournament != true }.count
            case .sixMonth:
    ...
    func bbPerHour(yearExcluded: String? = nil, range: RangeSelection = .all) -> Double {
        ...
        if let yearExcluded = yearExcluded {
            ...
            case .threeMonth:
                sessionsArray = filterSessionsLastThreeMonths().filter { $0.isTournament != true }
            case .sixMonth:
